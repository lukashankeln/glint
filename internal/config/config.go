...
type SchemaConfig struct {
	...
	IgnoreMissingSchemas  bool     `mapstructure:"ignore_missing_schemas"`
	SkipKinds             []string `mapstructure:"skip_kinds"`
	RejectKinds           []string `mapstructure:"reject_kinds"`
...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("schema.enabled", true)
	v.SetDefault("schema.kubernetes_version", DefaultKubernetesVersion)
	v.SetDefault("schema.strict", false)
	v.SetDefault("schema.ignore_missing_schemas", true)
	v.SetDefault("schema.skip_kinds", []string{"CustomResourceDefinition"})
	v.SetDefault("schema.locations", DefaultSchemaLocations)
	v.SetDefault("schema.cache_dir", cacheDir())
...
func cacheDir() string {
	...
	if err != nil {
		return ".glint/schema-cache"
	}
	return filepath.Join(home, ".glint", "schema-cache")
}
